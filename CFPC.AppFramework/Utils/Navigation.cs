...
namespace CFPC.AppFramework
{
    public static class Navigation
    {
        ...
        public static LoginPage GoToLoginPageMainpro(this IWebDriver driver, bool waitForInitialize = true)
        {
            var page = Navigate(p => new LoginPage(p), driver, waitForInitialize);
            return new LoginPage(driver);
        }

        public static LoginPage GoToLoginPageCert(this IWebDriver driver, bool waitForInitialize = true)
        {
            var page = Navigate(p => new LoginPage(p), driver, waitForInitialize);
            return new LoginPage(driver);
        }

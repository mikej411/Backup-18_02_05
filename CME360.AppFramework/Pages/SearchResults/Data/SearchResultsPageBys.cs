...
namespace CME.AppFramework
{
    ...
    public class SearchResultsPageBys
    {
        ...
        public readonly By ActivitiesTblBodyRow = By.XPath("//div[@id='ActivityResultsPanel']/descendant::table/tbody/tr[3]"); // if one row exists in this table, this will be that row

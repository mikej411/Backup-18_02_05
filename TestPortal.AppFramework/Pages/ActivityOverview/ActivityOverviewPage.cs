...
{
    public class ActivityOverviewPage : Page, IDisposable
    {
        #region constructors
        public ActivityOverviewPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public IWebElement ResumeSelectBtn { get { return this.FindElement(Bys.ActivityOverviewPage.CreditInfoLbl); } }
        ...
        public override void WaitForInitialize()
        {
            try
            {
                this.WaitUntil(TimeSpan.FromSeconds(15), Criteria.ActivityOverviewPage.PageReady);
            }
            catch
            {
                RefreshPage();
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose ActivityOverviewPage", activeRequests.Count, ex); }
        }

...
namespace RCP.AppFramework
{
    public class DiplomaAssessorPage : RCPPage, IDisposable
    {
        ...
        public void GoToSpecificMilestone(string milestoneName)
        {
            ...
            ElemSet.Grid_ClickButtonOrLinkWithinRow(Browser, MilestonesTbl, Bys.DiplomaAssessorPage.MilestonesTblFirstRow, milestoneName, "a", milestoneName, "a");
